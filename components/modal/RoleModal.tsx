...
const RoleModal: FC<Props> = ({ closeModal, children }) => {
      ...
      >
        <div className="flex justify-center min-h-screen px-4 pb-20 text-center sm:block sm:p-0 items-center pt-4">
          <motion.div
            ...
            exit="hidden"
            ref={ref}
            className="inline-block sm:w-[600px] w-full align-bottom bg-slate-800 rounded-lg px-4 pt-5 pb-4 text-left shadow-xl sm:my-8 sm:align-middle sm:p-6 opacity-100 translate-y-0 sm:scale-100"
          >
            {/* headline */}
